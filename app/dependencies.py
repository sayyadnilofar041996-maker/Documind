...
async def get_current_user(
    ...
    Raises 401 on any failure (never reveals the specific reason — security).
    """
    # Generic 401 — never reveal specific failure reason
    credentials_exception = HTTPException(
        status_code=status.HTTP_401_UNAUTHORIZED,
        detail={
            "type": "https://documind.local/problems/invalid-credentials",
            "title": "Unauthorized",
            "status": 401,
