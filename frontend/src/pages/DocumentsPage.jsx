      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="space-y-2">
            <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-500 ml-1">
              Upload Files
            </h3>
            <UploadBox />
          </div>

          <div className="bg-card border border-white/5 rounded-2xl p-6 hidden lg:block">
            <h4 className="text-white font-medium mb-3">Usage Tips</h4>
