...
class TestDocumentEndpoints:
    ...
    async def test_upload_success(self, mock_celery, client: AsyncClient, auth_headers: dict):
    ...
    async def test_get_status_success(self, mock_async_result, client: AsyncClient, auth_headers: dict):
        ...
        # Progress for PENDING is usually 0, or 50 if PROCESSING (service logic)
