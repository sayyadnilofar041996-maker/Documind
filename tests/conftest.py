...
# CRITICAL: Mock pgvector BEFORE any app imports
try:
    import pgvector.sqlalchemy
except ImportError:
    # If not installed at all, create dummy module
...
async def db(engine) -> AsyncGenerator[AsyncSession, None]:
    ...
    async with async_session() as session:
        ...
        await session.execute(text("TRUNCATE TABLE documents, users RESTART IDENTITY CASCADE"))
